    ...
    def draw(self):
        ...
        for child in self.children:
            ...
            if (child.border_width is not None and
                ...
                pygame.draw.pygame.Rect(surf, child.border_color, child._frame,
                                 child.border_width)
        return surf
...
class Label(Control):
    ...
    def __init__(self, text=None):
        ...
        self.font = pygame.font.SysFont(fn, fs)
        self.text = text
...
class Button(Control):
    ...
    def __init__(self, text):
        ...
        fn = 'Helvetica,Arial'
        fs = 18
        bold_font = pygame.font.SysFont(fn, fs, bold=True)
...
class Slider(Control):
    ...
    def value(self, new_value):
        ...
        if self.thumb is not None:
            ...
            self.thumb.frame = pygame.Rect(thumb_x, 0, thumb_w, thumb_h)

        h = 10
        self.track.frame = pygame.Rect(thumb_w // 2,
                                self._frame.h // 2 - h // 2,
        ...
        if value_w > 0:
            self.value_track.frame = pygame.Rect(thumb_w // 2 +
...
class Flipbook(Control):
    ...
    def _update_subimage(self):
        ...
        self.subimage = self.image.subsurface(pygame.Rect((x, 0), self.subimage_size))
...
class Scene(Control):
    def __init__(self):
        Control.__init__(self)
        self._frame = pygame.Rect((0, 0), window.get_size())
        self._focus = None
